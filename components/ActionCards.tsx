  ...
  return (
    ...
    >
      ...
      <div className="relative h-full flex flex-col justify-end p-8 z-10">
        <span className="text-[10px] font-medium tracking-[0.4em] text-brand-cream uppercase mb-2 drop-shadow-lg">
          {subtitle}
        </span>
        <h3 className="text-3xl md:text-4xl font-extralight tracking-tighter mb-4 text-brand-offwhite uppercase drop-shadow-md">
          {title}
        </h3>
