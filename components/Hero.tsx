    ...
    <section className="relative h-screen w-full flex flex-col items-center justify-end pb-32 overflow-hidden bg-brand-dark">
      ...
      <div className="relative z-20 text-center space-y-10 px-6 max-w-5xl">
        <div className="space-y-6 flex flex-col items-center">
          <h2 className="text-brand-cream text-[10px] md:text-[11px] font-prompt font-extralight tracking-[0.5em] uppercase opacity-80">
            ...
            <img
              ...
              onError={(e) => {
                ...
                if (parent) {
                  ...
                  title.className =
                    "text-5xl md:text-7xl font-thin text-brand-offwhite tracking-[-0.05em] uppercase";
                  title.innerHTML =
                    'Riquelme <span class="text-brand-cream">Emanuel</span>';
        ...
        <div className="flex flex-col items-center gap-10">
          ...
          <p className="text-[11px] md:text-xs font-prompt font-extralight tracking-[0.25em] text-brand-taupe uppercase max-w-xl mx-auto leading-relaxed">
            Metodologia exclusiva focada em{" "}
            <span className="text-brand-cream font-light">individualidade</span>{" "}
